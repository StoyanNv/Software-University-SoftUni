namespace HTTPServer.GameStore.Infrastructure
{
    using Data;
    using Server.Enums;
    ...
    {
        public const string DefaultPath = @"..\..\..\GameStore\Resources\{0}.html";
        ...
        protected GameStoreContext Context { get; private set; }
        ...
        protected IHttpResponse FileViewResponse(string fileName)
        {
            ...
            return new ViewResponse(HttpStatusCode.Ok, new IndexView(result));
        }
